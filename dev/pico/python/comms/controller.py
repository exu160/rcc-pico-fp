...
class WirelessInterface:
	picoip = '192.168.0.106'
	porttopico = 9900
	computerip = '192.168.0.209'
	porttocomputer = 9999
...
if __name__ == "__main__":
	...
	while True:
		...
		time.sleep(loop_time/3)
		while c.has_packet():
			c.outbound.put(pout) 		# adds pout to the outbound queue 
			pin = c.get_packet() 		# receive the packet 
			packet_receive_demux(pin)	# decodes the packet into a message 
